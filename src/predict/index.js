...
const model = genAI.getGenerativeModel({
	...
	systemInstruction: `All of the data must be in Vietnamese. 
        Description: 
        ...
        Suggestions: 
         -  Suggest based on the issue's affect on the rice plant and on the condition and the rice's stage provided by input (example. don't suggest "Chọn giống kháng..." when its in LATER stages (trổ bông, etc.)).
         -  DON'T SUGGEST TOO GENERALLY, suggestions should be specific, practical, well-detailed and as much as possible.
            (example: Luân canh với cây gì đễ tránh sâu đục thân, Dùng thiên địch gì)
